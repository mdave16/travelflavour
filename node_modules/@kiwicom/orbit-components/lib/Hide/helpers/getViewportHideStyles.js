...
var _index = _interopRequireDefault(require("../../utils/mediaQuery/index"));
...
var getViewportHideStyles = function getViewportHideStyles(on) {
  ...
  return _consts.DEVICES.map(function (viewport) {
    return viewport in _index.default ? (0, _styledComponents.css)(["", ";"], _index.default[viewport]((0, _styledComponents.css)(["display:", ";"], on.indexOf(viewport) !== -1 ? "none" : resolveDisplayProp()))) : // "smallMobile" is not media query so we need to check it explicitly
