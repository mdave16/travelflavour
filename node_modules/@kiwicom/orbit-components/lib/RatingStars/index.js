...
var RatingStars = function RatingStars(_ref) {
  ...
  (0, _js.warning)(color !== _consts2.ICON_COLORS.ATTENTION, "Warning: attention color of RatingStars component is deprecated. Please use primary color instead. Check https://orbit.kiwi/roadmap/road-to-1-0-0/#planned-breaking-changes for more information");
  ...
  return React.createElement(StyledRatingStars, {
    "data-test": dataTest,
    size: size,
    "aria-label": (0, _Translate.pureTranslate)(dictionary, "ratingstar_description", {
