...
var getHeight = function getHeight(_ref) {
  ...
  var type = _ref.type;
  var tokens = (_tokens = {}, _defineProperty(_tokens, _consts.default.BUTTON_LOADER, "100%"), _defineProperty(_tokens, _consts.default.SEARCH_LOADER, "40px"), _defineProperty(_tokens, _consts.default.BOX_LOADER, "80px"), _defineProperty(_tokens, _consts.default.PAGE_LOADER, "120px"), _defineProperty(_tokens, _consts.default.INLINE_LOADER, "19px"), _tokens);
...
var getAlign = function getAlign(_ref2) {
  ...
  var type = _ref2.type;
  var tokens = (_tokens2 = {}, _defineProperty(_tokens2, _consts.default.BUTTON_LOADER, "center"), _defineProperty(_tokens2, _consts.default.SEARCH_LOADER, "start"), _defineProperty(_tokens2, _consts.default.BOX_LOADER, "center"), _defineProperty(_tokens2, _consts.default.PAGE_LOADER, "center"), _defineProperty(_tokens2, _consts.default.INLINE_LOADER, "center"), _tokens2);
  return tokens[type];
}; // Animations
...
var StyledSpinnerCircle = _styledComponents.default.circle.withConfig({
  ...
  var theme = _ref17.theme,
      type = _ref17.type;
  return type === _consts.default.BUTTON_LOADER ? "currentColor" : theme.orbit.paletteInkLighter;
});
...
var Loading = function Loading(props) {
  ...
  return children && !loading ? children : React.createElement(StyledLoading, {
    type: type,
    dataTest: dataTest
  }, type === _consts.default.BOX_LOADER || type === _consts.default.SEARCH_LOADER || type === _consts.default.INLINE_LOADER ? React.createElement(StyledLoader, null, React.createElement(StyledLoaderCircle, null), React.createElement(StyledLoaderCircle, null), React.createElement(StyledLoaderCircle, null)) : React.createElement(StyledSpinner, {
    viewBox: "0 0 40 40"
    ...
    r: "18",
    type: type
  })), type !== _consts.default.BUTTON_LOADER && React.createElement(StyledLoadingText, {
    type: type
  }, text));
};
