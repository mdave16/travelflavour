...
})(["display:flex;flex-direction:column;margin:", ";flex:1;"], function (_ref9) {
...
})(["font-weight:", ";font-size:", ";color:", ";line-height:", ";", "{font-weight:", ";font-size:", ";color:", ";line-height:", ";}"], function (_ref13) {
...
})(["position:absolute;opacity:0;&:checked ~ ", " > ", "{font-weight:", ";& > ", "{font-weight:", ";}}&:checked + ", " > ", "{visibility:visible;}&:focus + ", "{outline:0;border:", ";}"], TextContainer, LabelText, function (_ref21) {
  var theme = _ref21.theme;
  return theme.orbit.fontWeightMedium;
}, _Text.StyledText, function (_ref22) {
  var theme = _ref22.theme;
  return theme.orbit.fontWeightMedium;
}, IconContainer, Glyph, IconContainer, function (_ref23) {
...
var Label = (0, _styledComponents.default)(function (_ref24) {
  var disabled = _ref24.disabled,
      theme = _ref24.theme,
      type = _ref24.type,
      hasError = _ref24.hasError,
      props = _objectWithoutProperties(_ref24, ["disabled", "theme", "type", "hasError"]);

  return React.createElement("label", props, props.children);
}).withConfig({
  displayName: "Radio__Label",
  componentId: "sc-5lanou-6"
})(["font-family:", ";display:flex;width:100%;flex-direction:row;align-items:self-start;opacity:", ";cursor:", ";position:relative;", "{border:1px solid ", ";}&:hover ", "{border-color:", ";}&:active ", "{border-color:", ";transform:", ";}"], function (_ref25) {
...
}, IconContainer, getBorderColor(), IconContainer, function (_ref28) {
