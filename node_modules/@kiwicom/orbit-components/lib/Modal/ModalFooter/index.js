...
function (_React$PureComponent) {
  ...
  function ModalFooter() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderWrappedChildren", function () {
      var _this$props2 = _this.props,
          children = _this$props2.children,
          _this$props2$flex = _this$props2.flex,
          flex = _this$props2$flex === void 0 ? "0 1 auto" : _this$props2$flex;

      var getChildFlex = function getChildFlex(key) {
...
var DecoratedComponent = (0, _ModalContext.withModalContext)(ModalFooter); // $FlowFixMe flow doesn't recognize displayName for functions
