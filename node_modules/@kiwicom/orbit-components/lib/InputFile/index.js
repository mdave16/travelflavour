...
})(["box-sizing:border-box;display:flex;align-items:center;padding:", ";height:", ";border-radius:", ";box-shadow:inset 0 0 0 ", ";background-color:", ";transition:box-shadow ", " ease-in-out;&:hover{box-shadow:inset 0 0 0 ", ";}", ":active{box-shadow:none;}"], function (_ref3) {
...
var InputFile = React.forwardRef(function (props, ref) {
  ...
  return React.createElement(Field, {
    ...
    "data-test": dataTest,
    "data-state": (0, _getFieldDataState.default)(!!props.error),
    type: "file",
    name: props.name,
    error: props.error,
