...
})(["display:flex;flex:0 1 auto;width:calc(100% - 96px);min-width:0;", "{line-height:1.2;}"], _Text.StyledText);
...
})(["display:flex;align-items:center;position:absolute;", ":", ";top:0;height:100%;"], _rtl.right, function (_ref15) {
...
var StyledTripSegmentOverviewColumn = _styledComponents.default.div.withConfig({
  ...
  return grow && (0, _styledComponents.css)(["min-width:0;flex:1;"]);
});
...
function (_React$PureComponent) {
  ...
  function TripSegment(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "tripSegmentID", (0, _randomID.default)("tripSegmentID"));
  ...
  _createClass(TripSegment, [{
    ...
    value: function render() {
      ...
      return React.createElement(StyledTripSegment, {
        ...
        element: "div",
        type: "primary"
      }, React.createElement(_Truncate.default, null, departure)), React.createElement(_Text.default, {
        element: "div",
        type: "primary"
      }, React.createElement(_Truncate.default, null, arrival)))), React.createElement(StyledTripSegmentCarrier, null, React.createElement(_Text.default, {
        element: "div",
        type: "secondary",
        size: "small"
