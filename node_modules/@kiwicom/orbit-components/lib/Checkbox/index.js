...
var Checkbox = _react.default.forwardRef(function (props, ref) {
  ...
  var preventOnClick = (0, _react.useCallback)(function (ev) {
    ev.preventDefault();
  }, []);
  return _react.default.createElement(Label, {
    disabled: disabled,
  ...
  }, _react.default.createElement(_Check.default, null)), (label || info) && _react.default.createElement(TextContainer, null, label && _react.default.createElement(LabelText, null, label), info && _react.default.createElement(Info, null, info)));
});
