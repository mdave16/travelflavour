...
})(["width:", ";height:", ";flex-shrink:0;vertical-align:middle;fill:currentColor;color:", ";", ";"], ({
  size
}) => getSize(size), ({
  size
}) => getSize(size), ({
...
const OrbitIcon = props => {
  ...
  warning(color !== ICON_COLORS.ATTENTION, "Warning: attention color of all Icon components is deprecated. Please use primary color instead. Check https://orbit.kiwi/roadmap/road-to-1-0-0/#planned-breaking-changes for more information");
