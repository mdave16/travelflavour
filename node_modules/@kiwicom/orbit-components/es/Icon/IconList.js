...
})(["font-family:\"SFMono-Regular\",Consolas,\"Liberation Mono\",Menlo,Courier,monospace;font-size:12px;line-height:", ";color:", ";background-color:", ";border:", " ", " ", ";padding:", " ", ";"], defaultTokens.lineHeightText, defaultTokens.paletteInkNormal, defaultTokens.paletteCloudLight, defaultTokens.borderWidthCard, defaultTokens.borderStyleCard, defaultTokens.paletteCloudNormal, defaultTokens.spaceXXSmall, defaultTokens.spaceXSmall);

const IconList = () => React.createElement(List, null, Object.keys(Icons).map(icon => {
  ...
  return React.createElement(Container, {
    ...
    size: "large",
    color: "primary"
  }), React.createElement(IconImport, null, `import ${iconName} from "@kiwicom/orbit-components/lib/icons/${iconName}"`));
}));
