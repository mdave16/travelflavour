...
const CardCloseButton = ({
  ...
  return React.createElement(StyledCloseContainer, null, React.createElement(ButtonLink, {
    dataTest: dataTest,
    type: "secondary",
    size: "small",
...
class Card extends React.Component {
  ...
  render() {
    ...
    }, children && React.Children.map(children, (item, index) => this.renderSection(item, index)), closable && React.createElement(CardCloseButton, {
      onClick: onClose,
