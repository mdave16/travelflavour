...
const Content = styled(StyledDiv).withConfig({
...
})(["display:block;margin-bottom:", ";line-height:", ";& a,& ", "{color:", ";font-weight:", ";transition:color ", " ease-in-out;&:hover,&:focus,&:active{color:", ";}}& ", ",", "{color:", ";}"], ({
  theme,
  title,
  inlineActions
  ...
  theme
}) => theme.orbit.durationFast, getTypeToken(TOKENS.colorTextLinkAlertHover), Item, StyledText, getTypeToken(TOKENS.colorTextAlert));
