...
export class PureModal extends React.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "handleClickOutside", ev => {
      ...
      if (onClose && this.modalContent.current && ev.target instanceof Element && !this.modalContent.current.contains(ev.target) && /ModalBody|ModalWrapper/.test(ev.target.className)) {
